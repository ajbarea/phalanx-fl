...
from intellifl.attack_utils.vocabularies.financial import FINANCIAL
from intellifl.attack_utils.vocabularies.legal import LEGAL
from intellifl.attack_utils.vocabularies.medical import MEDICAL
