...
!!! info "Mathematical Bounds"
    Byzantine-robust strategies (Krum, RFA, Trimmed Mean) have strict mathematical requirements for stability (e.g., $n > 2f + 2$). Phalanx will reject configurations that violate these bounds to ensure research integrity. See [Configuration](configuration.md#research-integrity--validation) for details.
